	...
	public static CompletableFuture<Void> stopMusic(@Nonnull Player player) {
		...
		return CompletableFuture.runAsync(() -> {
			...
			XSound[] musics = {MUSIC_CREATIVE, MUSIC_CREDITS,
				...
				MUSIC_DISC_WAIT, MUSIC_DISC_WARD, MUSIC_DRAGON, MUSIC_END, MUSIC_GAME, MUSIC_MENU,
				MUSIC_NETHER_BASALT_DELTAS, MUSIC_UNDER_WATER, MUSIC_NETHER_CRIMSON_FOREST, MUSIC_NETHER_WARPED_FOREST};
